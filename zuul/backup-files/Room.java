...
public class Room 
{
     ...
     *     Exits: north west
     * Items are also included in the description of the room
     *     
    ...
    public String getLongDescription()
    {
        ...
        if (!items.isEmpty())
        {
            longDesc += "There are a few items here: ";
            for (int i = 0; i < items.size()-1; i++)
            {
                longDesc += items.get(i).getDescription() + ", ";
            }
            longDesc += items.get(items.size()-1).getDescription();
        }
        return longDesc + ".\n" + getExitString();
    }
     ...
     * @param weight Double representing item's weight
     */
